...
### [website git(including a README.md)](https://github.com/crc0507/classifier-of-geek-board-game)
...
# Introduction
#### 该篇博客从零实现了朴素贝叶斯，并且详细讲解了朴素贝叶斯对于离散型数据的分类原理。我们的目标是建立一个分类模型，以使用朴素贝叶斯预测评论的评分。
#### 朴素贝叶斯的基本思想是：对于给定要分类的数据，找到出现该数据在每个类别的出现概率，以最大者为准，认为该数据将被分类属于该类别。
